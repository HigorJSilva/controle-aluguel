...
new class extends Component
{
    ...
    {
        $this->nome = $this->inquilino->nome;
        $this->documento = Formatacao::documento($this->inquilino->documento);
        $this->email = $this->inquilino->email;
        $this->telefone = $this->inquilino->telefone;
        $this->observacao = $this->inquilino->observacao;
    }
    ...
    public function save(): void
    {
        ...
        $inquilinoDto = new EditInquilinoDTO(...$payload);

        $inquilino = EditInquilino::run($inquilinoDto, $this->inquilino);
    ...
    public function updatedDocumento(string $documento, BuscaDocumentoStrategy $buscaDocumento): void
    {
        ...
        if ($this->inquilino->documento === $documento) {
            return;
        }
...
<x-mary-card>
    ...
    <x-mary-card>
        ...
        <x-mary-card class="shadow border border-base-300">
            <div class="px-6 pt-6">
                <h2 class='text-xl font-semibold text-base-content'>{{ __("messages.tenant_edit_title") }}</h2>
