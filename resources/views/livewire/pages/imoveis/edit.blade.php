...
new class extends Component
{
    ...
    public function save(): void
    {
        ...
        $imovelDto = new EditImovelDTO(...$validateFields);

        $imovel = EditImovel::run($imovelDto, $this->imovel, $this->imovel->endereco);

        if ($imovel) {
            $this->success(__("messages.edited"), timeout: 5000);
    ...
    {
        $this->titulo = $this->imovel->titulo;
        $this->tipo = $this->imovel->tipo;
        $this->endereco = $this->imovel->endereco->endereco;
        $this->bairro = $this->imovel->endereco->bairro;
        $this->cidade = $this->imovel->endereco->cidade;
        $this->estado = $this->imovel->endereco->estado;
        $this->cep = $this->imovel->endereco->cep;
        $this->valorAluguelSugerido = $this->imovel->valor_aluguel_sugerido;
        $this->status = $this->imovel->status;
        $this->quartos = $this->imovel->quartos;
        $this->banheiros = $this->imovel->banheiros;
        $this->area = $this->imovel->area;
                ...
                <div class="mt-6 flex items-center justify-end gap-3">
                    ...
                    <button type="submit"
                        ...
                        wire:loading.class="opacity-50"
                         class="inline-flex items-center justify-center rounded-lg bg-primary px-4 py-2 text-primary-content hover:bg-primary/90">
                        {{ __("messages.save") }}
                    </button>
                </div>
            </form>
